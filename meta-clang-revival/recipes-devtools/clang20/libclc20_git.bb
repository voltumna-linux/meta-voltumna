...
# Depend explicitly on clang20-native instead of using TOOLCHAIN as the build
# objects from this recipe are built explicitly using clang for GPU targets.
...
DEPENDS += "clang20-native spirv-llvm-translator-llvm20-native"
