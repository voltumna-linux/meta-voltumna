...
PN = "clang20-cross-canadian-${TRANSLATED_TARGET_ARCH}"

inherit cross-canadian

DEPENDS = "nativesdk-clang20 binutils-cross-canadian-${TRANSLATED_TARGET_ARCH} virtual/nativesdk-cross-binutils virtual/nativesdk-libc ${@bb.utils.contains('DISTRO_FEATURES', 'ld-is-lld', 'nativesdk-lld', '', d)}"
