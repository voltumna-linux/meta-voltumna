...
PN = "clang17-cross-canadian-${TRANSLATED_TARGET_ARCH}"

require common-clang.inc
require common-source.inc
inherit cross-canadian

DEPENDS += "nativesdk-clang17 binutils-cross-canadian-${TRANSLATED_TARGET_ARCH} virtual/nativesdk-cross-binutils virtual/nativesdk-libc"
