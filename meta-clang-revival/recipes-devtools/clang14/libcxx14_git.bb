...
PACKAGECONFIG[compiler-rt] = "-DLIBCXX_USE_COMPILER_RT=ON -DLIBCXXABI_USE_COMPILER_RT=ON -DLIBUNWIND_USE_COMPILER_RT=ON,,compiler-rt14"
...
CC:append:class-native = " -unwindlib=libgcc -rtlib=libgcc"
CC:append:class-nativesdk = " -unwindlib=libgcc -rtlib=libgcc"
...
PACKAGES:append:runtime-llvm = " libunwind14"
FILES:libunwind14:runtime-llvm = "${libdir}/libunwind.so.*"

BBCLASSEXTEND = "native nativesdk"
TOOLCHAIN = "clang14"
TOOLCHAIN_NATIVE = "clang14"
