...
DEPENDS += "libgcc"
DEPENDS:append:class-target = " virtual/cross-c++ ${MLPREFIX}clang16-cross-${TARGET_ARCH} virtual/${MLPREFIX}libc gcc-runtime"
DEPENDS:append:class-nativesdk = " virtual/cross-c++ clang16-native clang16-crosssdk-${SDK_SYS} nativesdk-gcc-runtime"
