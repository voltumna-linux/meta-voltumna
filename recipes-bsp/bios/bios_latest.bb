...
# 3.5
SRC_URI_append_ssg-6039p-e1cr16h = " file://X11DPH-I,T,Tq_3.5_AS1.73.11_SUM2.5.2.zip;name=bios-ssg"
SRC_URI_append_sys-5019p-wtr = " file://BIOS_X11SPW-0953_20210518_3.5_STD.zip;name=bios-sys"
# 1.9
