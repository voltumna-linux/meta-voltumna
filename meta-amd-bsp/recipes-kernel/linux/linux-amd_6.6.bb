DESCRIPTION = "AMD common kernel recipe for Linux 6.6.y"
...
python () {
    ...
    if major != "6.6":
        raise bb.parse.SkipRecipe("Skipping linux-amd_6.6.bb because major version is %s" % major)
}
...
INTERNAL_KERNEL_VERSION = "${@d.getVar('PREFERRED_VERSION_linux-amd') or '6.6.53'}"
