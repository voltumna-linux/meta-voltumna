...
PACKAGECONFIG[compiler-rt] = "-DLIBCXX_USE_COMPILER_RT=ON -DLIBCXXABI_USE_COMPILER_RT=ON -DLIBUNWIND_USE_COMPILER_RT=ON,,compiler-rt17"
...
CC:append:toolchain-clang17:class-native = " -unwindlib=libgcc -rtlib=libgcc"
CC:append:toolchain-clang17:class-nativesdk = " -unwindlib=libgcc -rtlib=libgcc"
...
PROVIDES:append:runtime-llvm = " libunwind17"
...
PACKAGES:append:runtime-llvm = " libunwind17"
