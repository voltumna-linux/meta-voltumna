...
DEPENDS += "ninja-native virtual/crypt compiler-rt17"
DEPENDS:append:class-native = " clang17-native libxcrypt-native"
DEPENDS:append:class-nativesdk = " clang17-native clang17-crosssdk-${SDK_ARCH} nativesdk-libxcrypt"
