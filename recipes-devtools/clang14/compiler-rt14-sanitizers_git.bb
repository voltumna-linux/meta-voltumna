...
DEPENDS:append:class-native = " clang14-native libxcrypt-native"
DEPENDS:append:class-nativesdk = " clang14-native clang14-crosssdk-${SDK_ARCH} nativesdk-libxcrypt"
...
TOOLCHAIN:forcevariable = "clang14"
