...
SRC_URI = "git://github.com/lxc/incus.git;branch=main;name=incus;protocol=https \
           file://incus.service \
           file://incus.socket \
           "

SRCREV_incus = "af6b34fc0560d031763c37d45e9cf9b893125f78"
SRCREV_FORMAT = "incus"
PV = "7.3.0+git"

COMPATIBLE_HOST = "(x86_64|aarch64).*-linux"

GO_IMPORT = "github.com/lxc/incus/v7"
...
# All cmd/ targets this recipe's do_compile builds. Used by license-scan
# filtering — scopes the license set to modules actually imported by these
# binaries via `go list -deps`. Without this, the filter falls back to
# walking the discovery's GOMODCACHE, which only sees what go build of the
# single GO_MOD_DISCOVERY_BUILD_TARGET (./cmd/incus-migrate) populated.
GO_MOD_DISCOVERY_LICENSE_TARGETS = "./cmd/incusd ./cmd/incus ./cmd/fuidshift ./cmd/lxc-to-incus ./cmd/incus-benchmark ./cmd/incus-user ./cmd/incus-agent ./cmd/incus-migrate"
