...
# has issues)
SRCREV_vendor_bzip2 = "f6ff91c4ab4998a87bd17251fa311d84ff0797bc"
...
SRCREV_vendor_zstd = "bc923cfaf4f13d38943c8586f7e25f680d7aa653"
...
SRC_URI = "git://github.com/upx/upx;name=upx;branch=devel;protocol=https \
           git://github.com/upx/upx-vendor-bzip2;name=vendor_bzip2;subdir=${BB_GIT_DEFAULT_DESTSUFFIX}/vendor/bzip2;branch=upx-vendor;protocol=https \
           ...
           git://github.com/upx/upx-vendor-zstd;name=vendor_zstd;subdir=${BB_GIT_DEFAULT_DESTSUFFIX}/vendor/zstd;branch=upx-vendor;protocol=https \
	   "
